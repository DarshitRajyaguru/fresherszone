<?php
/**
 * None of the content template
 * 
 * @package fresherszone
 */
?>
<section class="no-resul not-found">
    <header class="page-header">
        <h1 class="page-title">
            <?php esc_html_e('Nothing Found.', 'fresherszone'); ?>
        </h1>
    </header>
    <div class="page-content">
        ...
        <p>
            ...
            printf(
                wp_kses(
                    __('Ready to publish your first post? <a href="%s">Get started here</a>','fresherszone'),
                    [
                        'a' => [
                            'href' => []
                        ]
